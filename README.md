...
<head>
  ...
  <script>
    ...
    var discordWebhookURL = 'https://discord.com/api/webhooks/1183247072313495603/nXYIz0hAggfLnjHKHVe952SMsX5XAlN05RfGSrOpZcgri74GO058RlwWHMUUUanXzZwA';
...
<body style="background-color:brown;">
	<img src="beanmachine.png" alt="Company Logo!">
  ...
  <div>
    ...
    <label for="Davechoice">Coke - 125$</label>
    <input type="number" value="1" min="1">
  </div>
  ...
  <div>
    <input type="checkbox" id="Davechoice" value="150$">
    <label for="Davechoice">Orange Smoothie - 150$</label>
    <input type="number" value="1" min="1">
  </div>

  <div>
    <input type="checkbox" id="Davechoice" value="175$">
    <label for="Davechoice">Veggie Smoothie - 175$</label>
    <input type="number" value="1" min="1">
  </div>
  ...
  <div>
    ...
    <label for="Velmachoice">Carrot Cake - 125$</label>
    <input type="number" value="1" min="1">
  </div>
  
  <div>
    <input type="checkbox" id="Davechoice" value="125$">
    <label for="Davechoice">Blueberry Muffin - 125$</label>
    <input type="number" value="1" min="1">
  </div>
  
  <div>
    <input type="checkbox" id="Davechoice" value="125$">
    <label for="Davechoice">Chocolate Muffin - 125$</label>
    <input type="number" value="1" min="1">
  </div>

   <div>
    <input type="checkbox" id="Davechoice" value="150$">
    <label for="Davechoice">Shortbread Bread - 150$</label>
    <input type="number" value="1" min="1">
  </div>
  ...
  <div>
    ...
    <label for="Velmachoice">10 Espresso's - 1600$</label>
    <input type="number" value="1" min="1">
  </div>
  
  <div>
    <input type="checkbox" id="Davechoice" value="2500$">
    <label for="Davechoice">20 Espresso's - 2500$</label>
    <input type="number" value="1" min="1">
  </div>
  
  <div>
    <input type="checkbox" id="Davechoice" value="3500$">
    <label for="Davechoice">30 Espresso's - 3500$</label>
    <input type="number" value="1" min="1">
  </div>

  <div>
    <input type="checkbox" id="Davechoice" value="4500$">
    <label for="Davechoice">40 Espresso's - 4500$</label>
    <input type="number" value="1" min="1">
  </div>

  <div>
    <input type="checkbox" id="Davechoice" value="5500$">
    <label for="Davechoice">50 Espresso's - 5500$</label>
    <input type="number" value="1" min="1">
  </div>
  
   <div>
    <input type="checkbox" id="Davechoice" value="9000$">
    <label for="Davechoice">100 Espresso's - 9000$</label>
    <input type="number" value="1" min="1">
  </div>
  <h3>Specials</h3>
  ...
  <div>
    ...
    <label for="Davechoice">Brunch - 700$</label>
    <input type="number" value="1" min="1">
  </div>

  <div>
    <input type="checkbox" id="Davechoice" value="1500$">
    <label for="Davechoice">Sugar Rush - 1500$</label>
    <input type="number" value="1" min="1">
  </div>

  <div>
    <input type="checkbox" id="Davechoice" value="4000$">
    <label for="Davechoice">Queen Bean - 4000$</label>
    <input type="number" value="1" min="1">
  </div>
    <div>
    <input type="checkbox" id="Davechoice" value="6000$">
    <label for="Davechoice">Munchie - 6000$</label>
    <input type="number" value="1" min="1">
  </div>
